...
export const metadata: Metadata = {
    title: 'Our Mission, Vision and Team | OctoLab',
    description: 'Learn about OctoLab’s mission to simplify GitHub Actions workflows. Discover how we empower developers with a visual, no-code CI/CD automation platform.',
    alternates: {
        canonical: 'https://www.octolab.app/about',
    },
    keywords: [
        'about octolab',
        'octolab mission',
        ...
        'github actions team',
        'ci/cd no-code platform',
        'visual automation tools',
        'devops workflow builder',
        'github ci/cd made easy',
    ],
};
...
export default function AboutPage() {
    ...
    return (
        <>
            <Head>
                <link rel="canonical" href="https://www.octolab.app/about" key="canonical" />
            </Head>
            <main className="p-8 max-w-3xl mx-auto">
                ...
                <div className="text-text-muted space-y-6 text-lg">
                    ...
                    <p>
                        OctoLab also allows you to <span className="text-primary font-semibold">customize every aspect</span> of your workflow: runners, branch strategies, build
                        and test commands, security integrations, cloud deployments and much more. All from a{' '}
                        <span className="text-primary font-semibold">clear and intuitive interface</span>.
                    </p>

                    <p>
                        Currently, OctoLab is in <span className="text-primary font-semibold">Beta phase</span>, where we are validating the product with our community. If the
                        results are positive, we will continue to expand the platform with new features, integrations and enhancements to help you take automation to the next
                        level.
                    </p>
