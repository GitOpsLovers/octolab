    ...
    return (
        <main className="p-8 max-w-3xl mx-auto">
            ...
            <div className="text-text-muted space-y-6 text-lg">
                ...
                <p>
                    As you build, OctoLab generates the corresponding GitHub Actions workflow in real time. You can view the code at any moment and see how your design translates
                    into an executable configuration.
                </p>
