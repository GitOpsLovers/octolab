...
export const metadata: Metadata = {
    title: 'Privacy Policy | OctoLab',
    description: 'Read how OctoLab collects, uses, and protects your personal data when using our GitHub Actions workflow builder.',
    alternates: {
        canonical: 'https://www.octolab.app/privacy',
    },
    keywords: [
        'octolab privacy',
        'data protection github',
        'github actions privacy',
        'ci/cd privacy policy',
        'workflow builder data policy',
        'octolab data collection',
        'cookie policy github app',
...
export default function PrivacyPage() {
    ...
    return (
        <>
            <Head>
                <link rel="canonical" href="https://www.octolab.app/privacy" key="canonical" />
            </Head>
            <main className="p-8 max-w-3xl mx-auto">
                ...
                <div className="text-text-muted space-y-6 text-lg">
                    <p>
                        At <strong className="text-text">OctoLab</strong>, we take your privacy seriously. This Privacy Policy explains what data we collect, how we use it, and
                        your rights when using our application.
                    </p>
